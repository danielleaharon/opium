...
<button onClick={()=>this.setState({details:0})} className='close-details-btn'><span class="iconify" data-icon="feather:x"></span></button>
</p>
       ...
       <br/><br/>
<a className='span_red'  href='https://www.youtube.com/watch?v=d4A4xkFfNsE' target='_blank'>לסרטון בנושא <span class="iconify" data-icon="dashicons:video-alt3" data-inline="false"></span></a>
<button onClick={()=>this.setState({details:0})} className='close-details-btn'><span class="iconify" data-icon="feather:x"></span></button>
</p>
       ...
       <br/><br/>
<a className='span_pink'  href='https://www.youtube.com/watch?v=RSpsWewtxXw' target='_blank'>לסרטון בנושא <span class="iconify" data-icon="dashicons:video-alt3" data-inline="false"></span></a>
<button onClick={()=>this.setState({details:0})} className='close-details-btn'><span class="iconify" data-icon="feather:x"></span></button>
</p>
...
<a className='span_purple'  href='https://www.youtube.com/watch?v=lUEBtKSGVI4' target='_blank'>לסרטון בנושא <span class="iconify" data-icon="dashicons:video-alt3" data-inline="false"></span></a>
<button onClick={()=>this.setState({details:0})} className='close-details-btn'><span class="iconify" data-icon="feather:x"></span></button>
</p>
...
<a className='span_blue'  href='https://www.youtube.com/watch?v=-wzg5eXeawk' target='_blank'>לסרטון בנושא <span class="iconify" data-icon="dashicons:video-alt3" data-inline="false"></span></a>
<button onClick={()=>this.setState({details:0})} className='close-details-btn'><span class="iconify" data-icon="feather:x"></span></button>
</p>
