...
this.setState({heightText:document.getElementById('textcenter-input'+this.props.item.getId()).clientHeight})
    ...
    return (
        ...
        top: this.state.topText,  }}  >
           <input type='text'   style={{fontSize:this.state.widthText+'%',
          ...
          backgroundColor:this.state.backgroundColor,
           transform: `rotate(${this.state.rotateAngleText}deg)`,
            color:this.state.textColor ,fontFamily:this.state.activeFontFamily}} onClick={this.click} className='textcenter-input' id={'textcenter-input'+this.props.item.getId()} onChange={this.handleChangeText}  value={this.state.text}></input>
